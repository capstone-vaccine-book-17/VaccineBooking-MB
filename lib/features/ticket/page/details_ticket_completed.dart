...
import 'package:w_vaccine/features/ticket/view_model/detail_ticket_complete_view_model.dart';
import 'package:w_vaccine/features/ticket/view_model/ticket_complete_view_model.dart';
import 'package:w_vaccine/features/ticket/view_model/ticket_complete_view_model.dart';
import 'package:w_vaccine/styles/custom_color.dart';

import '../view_model/detail_ticket_complete_view_model.dart';
import '../view_model/detail_ticket_complete_view_model.dart';
import '../view_model/ticket_complete_view_model.dart';
import '../view_model/ticket_complete_view_model.dart';
...
class _TicketVaccineCompletedState extends State<TicketVaccineCompleted> {
  ...
  Widget build(BuildContext context) {
    final vm =
        Provider.of<DetailTicketCompleteViewModel>(context, listen: false);
    return Scaffold(
        appBar: AppBar(
