...
class TicketCompleteViewModel with ChangeNotifier {
...
final _ticketRepository = getIt.get<TicketRepository>();
List<TicketData> _ticketComplete = [];

List<TicketData> get ticketComplete => _ticketComplete;
